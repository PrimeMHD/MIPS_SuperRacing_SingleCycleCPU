...
HD_PWD='D:/WeCloudSync/6.MI_PROJECTS/VIVADO_PROJECT/Mips54_App/Mips54_App/Mips54_LoadBoard_vMDU.runs/gmem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gmem.vds -m64 -mode batch -messageDb vivado.pb -notrace -source gmem.tcl
