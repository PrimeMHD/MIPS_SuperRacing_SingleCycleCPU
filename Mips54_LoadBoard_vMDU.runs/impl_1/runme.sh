...
HD_PWD='D:/WeCloudSync/6.MI_PROJECTS/VIVADO_PROJECT/Mips54_App/Mips54_App/Mips54_LoadBoard_vMDU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MipsSuperRacing.vdi -applog -m64 -messageDb vivado.pb -mode batch -source MipsSuperRacing.tcl -notrace
